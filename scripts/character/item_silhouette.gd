...
func _draw_weapon(c: Vector2, u: float) -> void:
	...
	var blade := PackedVector2Array([
		c + Vector2(0, -u * 0.98),
		c + Vector2(u * 0.16, -u * 0.55),
		c + Vector2(u * 0.16, u * 0.25),
		c + Vector2(-u * 0.16, u * 0.25),
		c + Vector2(-u * 0.16, -u * 0.55),
	])
	draw_colored_polygon(blade, tint)
	draw_rect(Rect2(c + Vector2(-u * 0.6, u * 0.22), Vector2(u * 1.2, u * 0.2)), tint)  # crossguard
	draw_rect(Rect2(c + Vector2(-u * 0.1, u * 0.42), Vector2(u * 0.2, u * 0.4)), tint)  # hilt
	draw_circle(c + Vector2(0, u * 0.9), u * 0.16, tint)  # pommel
