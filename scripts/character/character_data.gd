...
const STAT_INFO := {
	"STR": "Strength — +0.6 melee damage per point, and +10 carry capacity per point. Spare carry capacity also speeds up your attack-speed proc a little (capped — see Dexterity).",
	"DEX": "Dexterity — your attack-speed stat. Every (46 − 0.6 × Dexterity) attack cards played, your next attack costs half tempo and 2 less mana. Every 5 points mean 3 fewer attacks needed to proc. Traveling light shaves off up to 8 more; being loaded down adds up to 10. Dual wielding shaves another 4.",
	"INT": "Intelligence — +0.6 spell & heal power per point, and +0.16 mana regen per point (about +1 per 6).",
