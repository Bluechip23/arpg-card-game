...
static func create_brad_tree(max_level: int = 20) -> SkillTreeData:
	...
	var ability_placements := [
		{level = 2, slot = 0, archetype = "Berserker", name = "Enraged Will",
			description = "When you drop below 25% HP, perform a Reach AOE swing hitting all nearby enemies. Gain 10 mana per kill. Cooldown: 10 tempo",
		...
		{level = 8, slot = 0, archetype = "Warden", name = "The Way of the Plate",
			description = "Every other Defense card refunds 10 mana and 1 tempo",
			color = Color(0.3, 0.7, 1.0)},
		{level = 9, slot = 3, archetype = "The Ancient", name = "Ancestral Aid",
			description = "Each cycle: more attacks in hand → discount a random attack by 20m. More defense → heal 3 HP",
			color = Color(0.4, 0.9, 0.4)},
	...
	var card_placements := [
		...
		{level = 4, slot = 1, card_id = "roar", name = "Roar", description = "Knock enemies back 1 space. (10 mana, 2 tempo)"},
		{level = 5, slot = 0, card_id = "life_steal", name = "Life Steal", description = "Heal for the amount of damage done on next hit. (10 mana, 2 tempo)"},
		{level = 6, slot = 0, card_id = "parry", name = "Parry", description = "Gain 5 armor, deal 5 damage. Next damage to you is reduced. (10 mana, 5 tempo)"},
		{level = 7, slot = 0, card_id = "morphine", name = "Morphine", description = "Gain 4 temp HP. After 3 turns, lose it and take 2 damage. (30 mana, 0 tempo)"},
		{level = 8, slot = 1, card_id = "approach", name = "Approach", description = "Slowed for 10 tempo. For each movement taken, gain 5 armor. (10 mana, 3 tempo)"},
		{level = 9, slot = 0, card_id = "taunt", name = "Taunt", description = "Taunt enemies around you. They must target you. (40 mana, 0 tempo)"},
		{level = 10, slot = 0, card_id = "charge", name = "Charge", description = "Charge forward, deal 8 damage to all enemies hit and knock them back. (20 mana, 4 tempo)"},
		{level = 11, slot = 0, card_id = "turtle_up", name = "Turtle Up", description = "Armor does not decay for 20 tempo. (30 mana, 0 tempo)"},
		{level = 12, slot = 0, card_id = "armor_break", name = "Armor Break", description = "Next attack deals double damage to armor only. (30 mana, 4 tempo)"},
		{level = 14, slot = 0, card_id = "life_swap", name = "Life Swap", description = "Exchange HP and mana pools (10 mana = 1 HP). Deal damage equal to HP lost. (40 mana, 4 tempo)"},
		{level = 16, slot = 0, card_id = "heroic_leap", name = "Heroic Leap", description = "Jump based on STR. Deal 12 damage based on distance leaped. AOE circle. (40 mana, 5 tempo)"},
		{level = 18, slot = 0, card_id = "hold_the_line", name = "Hold the Line", description = "All allies gain 5 armor, +2 DET, and +2 STR. (40 mana, 5 tempo)"},
		{level = 2, slot = 2, card_id = "internal_combustion", name = "Internal Combustion", description = "Remove half your armor and deal damage around you based on the amount. (40 mana, 5 tempo)"},
		{level = 3, slot = 2, card_id = "savage_strike", name = "Savage Strike", description = "Deal 6 damage. Add a copy with Erase 20 to your discard pile. (20 mana, 2 tempo)"},
		{level = 4, slot = 0, card_id = "heavy_swing", name = "Heavy Swing", description = "Can only be played if only attack cards are in your hand. Deal 20 damage. (30 mana, 3 tempo)"},
		{level = 5, slot = 1, card_id = "shed_weight", name = "Shed Weight", description = "Discard all defensive cards. For each discarded, subtract 1 tempo from a non-defensive card. (40 mana, 2 tempo)"},
		{level = 6, slot = 1, card_id = "give_in", name = "Give In", description = "Gain 30 mana. Next tempo-triggered draw is skipped. (0 mana, 2 tempo)"},
		{level = 9, slot = 1, card_id = "shield_slam", name = "Shield Slam", description = "Deal damage based on your current armor. Lose half your armor. (50 mana, 10 tempo)"},
		{level = 10, slot = 1, card_id = "tower_shield", name = "Tower Shield", description = "Gain 40 armor. Become staggered for 40 tempo. (50 mana, 5 tempo)"},
		{level = 11, slot = 1, card_id = "living_armor", name = "Living Armor", description = "Gain regen until it is equal to your fortify. (30 mana, 5 tempo)"},
		{level = 12, slot = 1, card_id = "the_lights_favor", name = "The Light's Favor", description = "Heal 5 and draw a card. (20 mana, 0 tempo)"},
		{level = 13, slot = 1, card_id = "hunker_down", name = "Hunker Down", description = "Gain Fortify for 30 tempo. (40 mana, 2 tempo)"},
		...
		{level = 17, slot = 0, card_id = "harden", name = "Harden", description = "Gain 10% physical resistance for 15 tempo and 10 armor. (30 mana, 4 tempo)"},
		{level = 19, slot = 0, card_id = "roll", name = "Roll", description = "Roll X squares (max 5). On hitting an enemy, deal 10 damage and disarm for 5 tempo. (10 mana, 5 tempo)"},
	]
...
static func create_stephen_tree(max_level: int = 20) -> SkillTreeData:
	...
	var card_placements := [
		{level = 2, slot = 1, card_id = "quick_shot", name = "Quick Shot", description = "Deal 2 damage + half modifiers, draw a card. Ranged, Arrow. (10 mana, 1 tempo)"},
		{level = 3, slot = 0, card_id = "mixed_bag", name = "Mixed Bag", description = "Shoot a standard arrow, 7 damage. Ranged, Arrow. (10 mana, 1 tempo)"},
		{level = 4, slot = 0, card_id = "rise", name = "Rise", description = "Lift the earth creating a structure on the map. (10 mana, 4 tempo)"},
		{level = 5, slot = 0, card_id = "reload", name = "Reload", description = "Draw 3 cards. (30 mana, 3 tempo)"},
		{level = 6, slot = 0, card_id = "mark", name = "Mark", description = "Marked target takes +3 damage from your attacks for 25 tempo. Ranged +7. (30 mana, 0 tempo)"},
		{level = 7, slot = 0, card_id = "barricade", name = "Barricade", description = "Create a barricade of land in front of you. (30 mana, 2 tempo)"},
		{level = 8, slot = 1, card_id = "tighten_string", name = "Tighten String", description = "Next 3 ranged attacks: +3 tempo, +6 damage, +6 range, +20% crit. (30 mana, 3 tempo)"},
		{level = 9, slot = 0, card_id = "down_town", name = "Down Town", description = "Very long range (+7) shot, 12 damage. Arrow. (30 mana, 5 tempo)"},
		{level = 10, slot = 0, card_id = "sky_attack", name = "Sky Attack", description = "Leap and shoot arrow down, 10 damage. High Ground bonus. Arrow. (10 mana, 4 tempo)"},
		{level = 11, slot = 0, card_id = "enchanted_quiver", name = "Enchanted Quiver", description = "Next 3 ranged attacks create a free Quick Arrow in hand. (40 mana, 5 tempo)"},
		{level = 12, slot = 0, card_id = "last_breath", name = "Last Breath", description = "Consume all remaining mana. Deal 3 damage per 10 mana spent. Arrow. (0 mana, 5 tempo)"},
		{level = 14, slot = 0, card_id = "sky_fall", name = "Sky Fall", description = "Shoot arrow upward. In 10 tempo, lands for 18 damage. Arrow. (30 mana, 5 tempo)"},
		{level = 15, slot = 0, card_id = "lead_arrow", name = "Lead Arrow", description = "1.8x damage (10 base). Requires high ground, lower range. Arrow. (30 mana, 5 tempo)"},
		{level = 16, slot = 0, card_id = "bottomless_quiver", name = "Bottomless Quiver", description = "Manifest 5: Overflow attack cards stored in quiver. (40 mana, 4 tempo)"},
		{level = 18, slot = 0, card_id = "collect_arrows", name = "Collect Arrows", description = "Place 2 attack cards from discard pile into hand. Glut: 15 tempo. (30 mana)"},
		{level = 13, slot = 1, card_id = "exhausted_assault", name = "Exhausted Assault", description = "While you have zero mana, costs 0 mana. Deal 4 damage 3 times. Glut 10. (40 mana, 3 tempo)"},
		{level = 17, slot = 0, card_id = "multishot", name = "Multishot", description = "Attack 3 times, each gaining 10% crit chance. Glut 5. (30 mana, 6 tempo)"},
		{level = 19, slot = 0, card_id = "specific_strike", name = "Specific Strike", description = "Costs +10m/+1t for each other card in your hand. (20 mana, 2 tempo)"},
		{level = 20, slot = 0, card_id = "spirit_arrow", name = "Spirit Arrow", description = "Arrow that shoots through all enemies and obstructions in a direct line. Arrow. (30 mana, 5 tempo)"},
	]
...
static func create_ryan_tree(max_level: int = 20) -> SkillTreeData:
	...
	var card_placements := [
		{level = 2, slot = 1, card_id = "reposition", name = "Reposition", description = "Discard a card and draw a new one. (10 mana, 2 tempo)"},
		{level = 3, slot = 0, card_id = "elixir", name = "Elixir", description = "Poison cards now heal instead. (10 mana, 2 tempo)"},
		{level = 4, slot = 0, card_id = "poisoned_blood", name = "Poisoned Blood", description = "Heal cards now apply damage instead. (10 mana, 2 tempo)"},
		...
		{level = 6, slot = 0, card_id = "shadows", name = "Shadows", description = "Go invisible for 10 tempo. (10 mana, 4 tempo)"},
		{level = 7, slot = 0, card_id = "preparation", name = "Preparation", description = "Next 2 utility cards cost 20 less. (30 mana, 3 tempo)"},
		{level = 8, slot = 1, card_id = "raged_circulation", name = "Raged Circulation", description = "Target receives 30% more from healing and regen for 15 tempo. Ranged. (20 mana, 2 tempo)"},
		...
		{level = 10, slot = 0, card_id = "premeditated", name = "Premeditated", description = "Deal 8 damage. If this Exposes the enemy, next attack deals +15 damage. (20 mana, 4 tempo)"},
		{level = 11, slot = 0, card_id = "shuriken_pouch", name = "Shuriken Pouch", description = "Manifest 3: Overflow cards become Shuriken (3 dmg, free, ranged). (30 mana, 2 tempo)"},
		{level = 12, slot = 0, card_id = "bloodlust", name = "Bloodlust", description = "Apply 3 Vulnerable to self. Gain 30 mana. Gain 3 Strengthen for 20 tempo. (0 mana, 5 tempo)"},
		{level = 14, slot = 0, card_id = "understanding", name = "Understanding", description = "After 10 tempo delay, next card auto-crits. (50 mana, 1 tempo)"},
		{level = 16, slot = 0, card_id = "lethal_recall", name = "Lethal Recall", description = "Trigger your last instant card's effect 2 times. (20 mana, 4 tempo)"},
		{level = 15, slot = 0, card_id = "adrenaline_shot", name = "Adrenaline Shot", description = "Decrease tempo of two cards in target's hand by 3. In 5 tempo, increase a random card by 3 and another by 2. (30 mana, 0 tempo)"},
		{level = 17, slot = 0, card_id = "patience", name = "Patience", description = "In 15 tempo, draw 3 cards. (20 mana, 3 tempo)"},
		{level = 19, slot = 0, card_id = "gargle_and_spit", name = "Gargle and Spit", description = "Heal 3 and provide +1 strength. Sticky 4. (10 mana, 1 tempo)"},
	]
...
static func create_cory_tree(max_level: int = 20) -> SkillTreeData:
	...
	var ability_placements := [
		...
		{level = 13, slot = 0, archetype = "Monk", name = "Self Reliance",
			description = "When you play 3 cards in a single tempo cycle, your next card costs -10m",
			color = Color(0.9, 0.3, 0.3)},
	...
	var card_placements := [
		{level = 2, slot = 1, card_id = "push", name = "Push", description = "Move a unit away from you X squares. Fist. (10 mana, 1 tempo)"},
		{level = 3, slot = 0, card_id = "trip", name = "Trip", description = "Deal 5 damage. Decrease enemy movement by 4. Fist. (20 mana, 4 tempo)"},
		{level = 4, slot = 0, card_id = "bob_and_weave", name = "Bob and Weave", description = "Gain 5 armor and draw a card. Fist. (20 mana, 1 tempo)"},
		{level = 5, slot = 0, card_id = "swap", name = "Swap", description = "Switch positions with an enemy or ally. Ranged +4. (20 mana, 3 tempo)"},
		{level = 6, slot = 0, card_id = "defensive_awareness", name = "Defensive Awareness", description = "Gain 3 armor for every enemy within 2 spaces. (30 mana, 2 tempo)"},
		{level = 7, slot = 0, card_id = "consecutive_snap", name = "Consecutive Snap", description = "3 damage. Each reuse: +9 damage, -10m/-1t cost. Sticky 3. Fist. (30 mana, 3 tempo)"},
		{level = 8, slot = 1, card_id = "round_em_up", name = "Round 'Em Up", description = "Pick a point. Enemies near it are displaced towards it. AOE circle, Ranged. (20 mana, 3 tempo)"},
		{level = 9, slot = 0, card_id = "sweeping_disarm", name = "Sweeping Disarm", description = "Surrounding enemies disarmed, deal 3 damage. AOE circle, Fist. (20 mana, 5 tempo)"},
		{level = 10, slot = 0, card_id = "choke", name = "Choke", description = "Silence enemy and deal damage per round. Sticky 3. Fist. (30 mana, 4 tempo)"},
		...
		{level = 14, slot = 0, card_id = "absorb_essence", name = "Absorb Essence", description = "Deal 1 damage to ALL things. Delay 10 tempo: obtain Energy Ball. AOE. (50 mana, 5 tempo)"},
		{level = 15, slot = 0, card_id = "misery_loves_company", name = "Misery Loves Company", description = "Your next AOE attack spreads the debuffs on yourself and all enemies hit, to all the enemies that are hit. (50 mana, 1 tempo)"},
		{level = 17, slot = 0, card_id = "release_tension", name = "Release Tension", description = "Remove a stack of debuffs from the enemy and heal for the amount of debuffs removed x3. Choose which debuff. (30 mana, 5 tempo)"},
		{level = 19, slot = 0, card_id = "vines", name = "Vines", description = "Summon vines holding an enemy in place for 3 turns. Deal 4 damage per turn the enemy is held still. (20 mana, 3 tempo)"},
		{level = 20, slot = 0, card_id = "exposed_artery", name = "Exposed Artery", description = "Deal damage equal to 0.5x the enemy's missing health %. (50 mana, 2 tempo)"},
	]
...
static func create_jeremy_tree(max_level: int = 20) -> SkillTreeData:
	...
	var card_placements := [
		{level = 2, slot = 1, card_id = "risk_it", name = "Risk It", description = "30% chance to receive the Biscuit. (10 mana, 0 tempo)"},
		{level = 3, slot = 0, card_id = "loaded_die", name = "Loaded Die", description = "Next card with a probability has +10% higher chance. Gem. (10 mana, 1 tempo)"},
		{level = 4, slot = 0, card_id = "trick_shot", name = "Trick Shot", description = "Deal 8 damage. 80% chance to bounce, -20% per bounce. Ranged. (20 mana, 4 tempo)"},
		{level = 5, slot = 0, card_id = "oops", name = "Oops", description = "4 damage per hit. 30% for 5 hits, 40% for 3 hits, 30% for 2 hits. (30 mana, 4 tempo)"},
		{level = 6, slot = 0, card_id = "hope_this_works", name = "Hope This Works", description = "50% to heal ally and provide STR for 3 attacks. (20 mana, 3 tempo)"},
		{level = 7, slot = 0, card_id = "surrounding_ice", name = "Surrounding Ice", description = "Ice stalagmites deal 15 damage around you. 30% miss chance per enemy. AOE. (30 mana, 4 tempo)"},
		{level = 8, slot = 1, card_id = "worst_that_could_happen", name = "What's the Worst?", description = "5 damage. 50% for +15 damage, 50% to stun target. (30 mana, 7 tempo)"},
		{level = 10, slot = 0, card_id = "try_this", name = "Try This!", description = "Ally +30 mana pool, +2 hand size for 10 tempo. 10% chance reverse. (30 mana, 4 tempo)"},
		{level = 11, slot = 0, card_id = "snowballs_chance", name = "A Snowball's Chance", description = "Searing fire 3 spaces forward. 50% to also spread snowballs in a cone. AOE line. (20 mana, 3 tempo)"},
		{level = 12, slot = 0, card_id = "lady_luck", name = "Lady Luck", description = "Bless an ally. Crit chance +30% for 5 attacks. (40 mana, 1 tempo)"},
		{level = 14, slot = 0, card_id = "if_pigs_could_fly", name = "If Pigs Could Fly", description = "Summon a flying pig that explodes for 15 damage. Ranged. (30 mana, 0 tempo)"},
		{level = 16, slot = 0, card_id = "house_money", name = "House Money", description = "Your next odds will automatically trigger. (40 mana, 5 tempo)"},
		{level = 3, slot = 2, card_id = "cryonics", name = "Cryonics", description = "Encase an ally in ice for 15 tempo. Untargetable, cannot act, heals 3 per 5 tempo. (10 mana, 6 tempo)"},
		{level = 6, slot = 1, card_id = "friendship", name = "Friendship", description = "Choose two allies. When one heals, both heal. When one takes damage, they split it. (30 mana, 0 tempo)"},
		{level = 9, slot = 0, card_id = "provider", name = "Provider", description = "Heal an ally 6 health and give them 10 mana. Burden. (10 mana, 1 tempo)"},
		{level = 13, slot = 1, card_id = "fireball", name = "Fireball", description = "Massive fireball. Range +5, 12 damage, 3 burn. Costs 10 less mana per fire spell this turn. AOE circle 4 sq. (80 mana, 8 tempo)"},
		{level = 15, slot = 0, card_id = "spark", name = "Spark", description = "3 damage. Ranged -2. Subtract 2 tempo from 2 random cards. In 15 tempo, add 2 tempo to 2 random cards. (10 mana, 3 tempo)"},
		{level = 17, slot = 0, card_id = "god_of_thunder", name = "God of Thunder", description = "Absorb all shock on enemies and cast a massive bolt dealing damage based on shock absorbed. (50 mana, 10 tempo)"},
		{level = 19, slot = 0, card_id = "worms_armageddon", name = "Worms Armageddon", description = "Rain meteors dealing significant damage. 10% to summon two Alaskan Bull Worms (12 HP, 6 dmg, burrowed). (50 mana, 10 tempo)"},
