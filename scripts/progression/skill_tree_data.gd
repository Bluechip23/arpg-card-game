...
static func create_stephen_tree(max_level: int = 20) -> SkillTreeData:
	...
	var ability_placements := [
		...
		{level = 3, slot = 1, archetype = "Sentinel", name = "Clean Exchange",
			description = "Anytime you draw a Defense card and the last card you played was an offensive card, or vice versa, give the drawn card -1 tempo — a drawn Defense card also gains +1→8 block (scales with rank)",
			color = Color(0.3, 0.7, 1.0)},
		{level = 4, slot = 2, archetype = "Ranger", name = "Eagle Eye",
			description = "Ranged offensive cards deal additional damage equal to 100%→240% of their range (scales with rank)",
			color = Color(0.4, 0.9, 0.4)},
		...
		{level = 7, slot = 1, archetype = "The Apex", name = "Easy Target",
			description = "When exposing your enemy, deal your damage again and gain +1→15 Strengthen (scales with rank)",
			color = Color(0.9, 0.3, 0.3)},
		...
		{level = 11, slot = 2, archetype = "Avenger", name = "Swing for the Fences",
			description = "Cards that have >4 tempo cost deal 100%→800% of their tempo cost (scales with rank) as additional damage",
			color = Color(0.8, 0.4, 0.9)},
		...
		{level = 18, slot = 3, archetype = "Avenger", name = "Dominate",
			description = "When triggering an attack speed proc, the proc resolves normally and you also gain a 30m/0t basic attack card and +2→16 Strengthen (scales with rank). Cooldown 5 tempo",
			color = Color(0.8, 0.4, 0.9)},
	]
...
static func create_ryan_tree(max_level: int = 20) -> SkillTreeData:
	...
	var ability_placements := [
		{level = 2, slot = 0, archetype = "Relentless Blade", name = "Keep Them Guessing",
			description = "After discarding 18→4 cards (scales with rank), -3t from a random card in your hand",
			color = Color(0.9, 0.3, 0.3)},
		...
		{level = 5, slot = 3, archetype = "Shadow Blade", name = "Now You See Me",
			description = "Displacing yourself (blinking, being swapped, or other non-standard movement) grants you invisibility. Cooldown 15→1 tempo (scales with rank)",
			color = Color(0.8, 0.4, 0.9)},
		...
		{level = 16, slot = 1, archetype = "Apothecary", name = "Mad Scientist",
			description = "The last card you played changes the outcome of your potion cards (scales with rank). Utility→Heal: +2→16 regen. Attack→Heal: +2→16 strengthen. Utility→Poison: +2→9 poison stacks. Defense→Poison: -1%→15% enemy physical defense.",
			color = Color(0.4, 0.9, 0.4)},
