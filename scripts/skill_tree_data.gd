...
static func create_stephen_tree(max_level: int = 20) -> SkillTreeData:
	...
	var ability_placements := [
		{level = 2, slot = 0, archetype = "The Apex", name = "Deadly",
			...
			color = Color(0.9, 0.3, 0.3)},
		{level = 3, slot = 1, archetype = "Sentinel", name = "Counter Stance",
			description = "When you block a melee attack, your next melee attack deals +4 damage",
			color = Color(0.3, 0.7, 1.0)},
		...
		{level = 13, slot = 0, archetype = "The Apex", name = "Skilled Momentum",
			...
			color = Color(0.9, 0.3, 0.3)},
		{level = 14, slot = 2, archetype = "Sentinel", name = "Riposte Mastery",
			description = "After blocking a melee attack, your next attack costs 0 tempo",
			color = Color(0.3, 0.7, 1.0)},
