...
- A base builder: the player gathers resources on their adventure and sends them home, growing a town that must be defended against trials. The end-game (defend the city, farm zones, keep building) layers directly on top of the story — it is not a separate mode
...
5. **The Home Base** - Resources sent home grow the town; recruited NPCs staff and defend it; trials test it. The city is permanent and cumulative, like everything else
