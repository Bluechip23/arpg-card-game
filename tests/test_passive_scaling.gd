...
func _initialize() -> void:
	...
	_check(PassiveScaling.value("in_the_trenches", "damage_mod", 1) == -50, "Trenches rank 1 = -50%")
	_check(PassiveScaling.value("in_the_trenches", "damage_mod", 11) == 0, "Trenches rank 11 = +0%")
	_check(PassiveScaling.value("in_the_trenches", "damage_mod", 15) == 20, "Trenches rank 15 = +20%")
	...
	_check(PassiveScaling.value("mad_scientist", "regen", 15) == 8, "Mad Scientist rank 15 = +8 regen")
	_check(PassiveScaling.value("mad_scientist", "strengthen", 15) == 8, "Mad Scientist rank 15 = +8 strengthen")
	...
	_check(PassiveScaling.value("swing_for_the_fences", "multiplier", 15) == 380, "Swing rank 15 = 380%")
	...
	_check(PassiveScaling.value("eagle_eye", "multiplier", 15) == 142, "Eagle Eye rank 15 = 142% of range")
