...
- **Dual wielding carries a weight tax.** Holding two (or more) non-shield weapons makes **every** wielded weapon count **15% heavier** toward your carry load — the penalty hits both hands, so a huge main-hand weapon can't hide behind a feather-light off-hand. Twin daggers barely notice; pairing two real weapons is a Strength commitment. Sword-and-shield doesn't count as dual wielding.
