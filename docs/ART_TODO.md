...
| 6 | Terrain decoration sprites: crates, barrels, rocks, shrubs, stalagmites, sewer pipes/grates, torch (3–4 frame flame cycle), water tiles (3-frame cycle) | 32×32 tiles / 32×48 props, environment ramps (mid-value band), painted top-light | Decorations are untextured colored boxes today. |
